...
<body onload="pageLoad()">
    ...
    <div id="recipeAdminPageContainer">
        ...
        <div id="adminRecipe">
        <button><a href="addRecipeJS.php">ADD YOUR JS RECIPE</a></button>
        <button><a href="addRecipePHP.php">ADD YOUR PHP RECIPE</a></button>
            <div class="row">
                <div id="recipeCard" class="column">
                    ...
                    <button type="button" id="viewTurkeyRecipe">SEE FULL RECIPE</button><br>
                    <!--<button><a href="updateRecipe.php">UPDATE RECIPE</a></button><br>
                    <button><a href="deleteRecipe.php">DELETE RECIPE</a></button>-->
                ...
                <div id="recipeCard" class="column">
                    ...
                    <button type="button" id="viewCookieRecipe">SEE FULL RECIPE</button><br>
                    <!--<button><a href="updateRecipe.php">UPDATE RECIPE</a></button><br>
                    <button><a href="deleteRecipe.php">DELETE RECIPE</a></button>-->
                </div><!--close recipe card-->
            </div><!--close row-->
                ...
                while($row = $stmt->fetch() ){      //$row is an associative array
                    echo "<div class='row'>";
                        echo "<div id='recipeCard' class='column'>";
                            ...
                            echo "<div><p>Instructions: " .$row["recipe_instructions"] . "</p></div>";
                            $recipeID = $row['recipe_id'];
                            echo "<div><a href='deleteRecipe.php?recipeID=$recipeID'><button>DELETE</button></a></div>";
                            echo "<div><a href='updateRecipe.php?recipeID=$recipeID'><button>UPDATE</button></a></div>";
                            //echo "<button><a href='updateRecipe.php'>UPDATE RECIPE</button><br>";
                            //echo "<button><a href='deleteRecipe.php'>DELETE RECIPE</a></button>";
                        echo "</div>";//close column
                    echo "</div>";//close .row
                }
            ?>

        </div><!--close admin recipes-->
