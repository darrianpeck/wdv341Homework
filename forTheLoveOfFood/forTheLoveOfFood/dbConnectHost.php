...
$username = "darrianpeck_wdv341";             //database username, different on local vs hosting account
$password = "DMPeck98@";                 //database password, different on local vs hosting account
$databasename = "darrianpeck_wdv341";        //will differ between local and hosting account
