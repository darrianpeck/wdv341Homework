<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if ($validInput){
            ...
            $sql = "INSERT INTO recipes_book";
            $sql .="(recipe_name, recipe_difficulty, recipe_ingredients, recipe_time, recipe_instructions, recipe_servings, recipe_image)";
            $sql .="VALUES ";
            $sql .="(:recipeName, :recipeDifficulty, :recipeIngredients, :recipeTime, :recipeInstructions, :recipeServings, :recipeImage)";
...
<body>
    ...
    <div id="addRecipeContainer">
        ...
        <div id="recipeForm">
            ...
            <div>
                <form name="addRecipeForm" id="addRecipeForm" method="post" enctype="multipart/form-data" action="addRecipePHP.php">
                    <p id="nameInput">
                    ...
                    <p id="ingredientList">
                        <label><b>Ingredients</b> (please enter ALL ingredient names and amounts needed)</label>
                        ...
                        <span class="errMsg"><?php echo $recipeIngredientsMsg; ?></span><br>
                    </p>
                    ...
                    <p id="instructionList">
                        <label><b>Instructions</b> (please enter ALL instructions one step at a time)</label>
                  ...
                  <input type="submit" name="submit" value="Submit to PHP">
